...
class MyNotes {
  ...
  deleteNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      url: universityData.root_url + '/index.php/wp-json/wp/v2/note/' + thisNote.data('id'),
      type: 'DELETE',
      success: response => {
        thisNote.slideUp();
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      url: universityData.root_url + '/index.php/wp-json/wp/v2/note/',
      type: 'POST',
      data: ourNewPost,
      success: response => {
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.getJSON(universityData.root_url + '/index.php/wp-json/university/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
                <div class="row">
                    <div class"one-third">
            ...
            `);
      this.isSpinnerVisible = false;
    }); // delet this code a bit later on
    // $.when(
...
/* harmony default export */ __webpack_exports__["default"] = (Search); // import axios from "axios"
// class Search {
//   // 1. describe and create/initiate our object
//   constructor() {
//     this.addSearchHTML()
